...
function About() {
  return (
    <div className='About'>
      ...
      <h2>How to:</h2>
      <ol>
        <li>From the home page, click "Add Birthday" Or click "Add Birthday" in the Header.</li>
        <li>Enter a friend's first name, last name, and select their birthday.</li>
        <li>Once you have added someone to your Birthday List, you can add a gift list to their profile.</li>
        <li>To view upcoming birtdays, click on "Upcoming B-Days" in the Header. You will see a list of upcoming birthdays and access gift lists.</li>
      </ol>
    </div>
  );
}
